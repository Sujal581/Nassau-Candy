...
with cl:
    ...
    chart_note("These routes consistently meet or beat delivery expectations. Use them as internal SLA benchmarks when setting customer commitments and negotiating service-level agreements.")
...
with cr:
    ...
    chart_note("Routes here exceed the portfolio average lead time. Focus carrier audits and routing reviews on the top entries for the largest impact on overall throughput.")
...
chart_note("A delay rate above 30% on any single route warrants an immediate carrier service review or full route redesign. Cross-reference with the fastest routes chart to identify viable detour options.")
...
chart_note("Each bubble is a route; bubble size = total shipment volume. Routes in the top-right quadrant (high lead time + high delay rate) pose the greatest SLA risk and should be prioritized for improvement. Hover to identify each route.")
...
chart_note("Full sortable ranking of all routes. Red cells in Avg Lead or Delay Rate columns mark the highest-risk routes. Download the CSV for deeper analysis in Excel or BI tools.")
st.download_button(
    "Download Route Data",
